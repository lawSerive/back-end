...
import law.counsel.global.response.FailedResponseBody;
...
public class SwaggerApiFailedResponseHandler {
    ...
    private Example createSwaggerExample(law.counsel.global.exception.ExceptionType exceptionType, String description) {
        // 공통 응답 스키마 구성
